...
const _c0 = function () { return ["/login/sign"]; };
...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login-page"]], decls: 16, vars: 9, consts: [[1, "whiteBg"], ["loginForm", "ngForm"], [1, "row", "pad15"], [1, "col-12", "padB50"], ["translate", "", 1, "login-text", "text-center"], ["name", "email", "jbPlaceholder", "view.common.email", "jbType", "email", 1, "col-12", 3, "ngModel", "jbRequired", "jbAutoFocus", "ngModelChange", "jbOnEnter"], ["name", "pass", "jbPlaceholder", "view.common.password", "jbErrorPos", "none", "jbType", "password", 1, "col-12", 3, "ngModel", "jbRequired", "ngModelChange", "jbOnEnter"], ["jbText", "view.login.log_in_btn", "jbType", "update", 1, "col-12", "full-width", 3, "jbDisabled", "jbAsyncPromise", "jbClick"], [1, "col-12", "padT30", "text-center", "col-sm-5", "text-sm-left"], [1, "forgot-pw", 3, "routerLink"], [1, "icon-lock"], ["translate", "", 1, "marL5"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
